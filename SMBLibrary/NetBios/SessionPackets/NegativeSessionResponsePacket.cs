...
namespace SMBLibrary.NetBios
{
    ...
    public class NegativeSessionResponsePacket : SessionPacket
    {
        ...
        public NegativeSessionResponsePacket(byte[] buffer, int offset, ArrayPool<byte> pool) : base(buffer, offset, pool)
        {
            ErrorCode = ByteReader.ReadByte(this.TrailerBytes, offset + 0);
        }
